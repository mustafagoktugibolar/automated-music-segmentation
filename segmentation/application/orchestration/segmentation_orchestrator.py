...
from segmentation.infrastructure.storage.blob_helper import AzureBlobCacheHelper
...
from segmentation.core.segmentation.utils import ALLOWED_ALGORITHMS, BASELINE_ALGORITHMS, canonical_algorithm_name
...
class SegmentationOrchestrator:
    ...
    def _validate_and_trim_params(self, params: dict | None, algorithms: list[str]) -> dict:
    ...
    async def process_upload(self, file, requested_algos: list[str], params: dict | None = None, webhook_url: str | None = None) -> str:
