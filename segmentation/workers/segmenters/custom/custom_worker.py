...
from segmentation.core.segmentation.utils import normalize_algorithm_result
from segmentation.workers.base_worker import BaseWorker
...
def _warmup_pipeline() -> None:
    ...
    """
    from segmentation.application.segmentation.custom_engine import _detect_active_region, _extract_downsampled_features
...
class CustomWorker(BaseWorker):
    ...
    def process_task(self, task: dict) -> dict:
        ...
        from segmentation.application.segmentation.custom_engine import process_file_path
