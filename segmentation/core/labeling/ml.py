...
# segmentation/core/labeling/ml.py -> .../labeling -> .../core -> .../segmentation -> repo root (3 levels up)
...
def predict_semantic_labels(
    ...
    descriptors:
        ...
        ``segmentation.core.labeling.heuristic.build_segment_descriptors``.  Passed directly
