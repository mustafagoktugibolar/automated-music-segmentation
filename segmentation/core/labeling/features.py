...
#  zcr_mean     [59]
_ACOUSTIC_DIM  = 60
_RMS_MEAN_IDX  = 50  # must stay in sync with segmentation.infrastructure.audio.features
_ONSET_IDX     = 52
_NORM_DUR_IDX  = 53
_CENTROID_IDX  = 57
...
def build_segment_label_vectors(
    ...
    descriptors:
        ...
        ``segmentation.infrastructure.audio.features.build_segment_descriptors``.
    ...
    if descriptors is None and file_path:
        from segmentation.infrastructure.audio.features import build_segment_descriptors as _bsd
