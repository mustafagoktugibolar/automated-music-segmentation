...
from shared.segmentation.utils import normalize_algorithm_result
...
def _warmup_pipeline() -> None:
    ...
    """
    from workers.segmenters.custom.segmentation_service import _detect_active_region, _extract_downsampled_features
